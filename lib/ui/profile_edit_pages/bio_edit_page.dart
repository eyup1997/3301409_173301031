...
class BioEditPage extends StatelessWidget {
  ...
  BioEditPage(this._profileEditController);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:ProfileEditAppBar(editController:_profileEditController,titleTex: "Ad Soyad",type: EditType.BIO, appBar: AppBar(),),
      body: _buildPage(),
    );
  }
